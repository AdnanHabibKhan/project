...
<form action="" method="post">
  <div class="container">
    ...
    <label for="Name"><b>First Name</b></label> <input type="text" placeholder="Enter you  first name" name="firstname" pattern="([A-Za-z0-9\. -]+)" required><br>

    <label for="psw"><b>Last Name</b></label>
     <input type="text" placeholder="Enter your last name" name="lastname" pattern="([A-Za-z0-9\. -]+)"required><br>
...
<label for="psw-repeat"><b>Birthday  &nbsp   &nbsp </b></label>
        <input type="text" placeholder="Enter date of birth" name="dob"  pattern="(/^\d{1,2}\/\d{1,2}\/\d{4}$/)" required><br>

<label for="passowrd"><b>Password  &nbsp   &nbsp </b></label>
    <input type="password" placeholder="Enter your  Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required><br>
